...
void Camera::readObject()
{
	...
	if (!fin.is_open())
	{
		...
		OutputDebugString("Impossível abrir o arquivo .obj\n");
		exit(1);
	}
	else
	{
				...
				else
				{
					...
					else
					{
						...
						if (flush.str()[0] == 'f')
						{
							...
							// copiando os novos valores adicionados para o vetor de manipulaçao
							...
							//manipulando o vetor de manipulação para gerar os triangulos
